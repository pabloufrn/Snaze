...
GameOverState::GameOverState(sf::RenderTarget& target, StateMachine* state_machine): 
m_screen("Game over screen"), m_machine(state_machine),  m_window(&target)
{
}
void GameOverState::init()
{
    ...
    sui::Text* score_text = new sui::Text("Your final score is: ", {0.0, 150.0});
